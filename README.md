In order to use the program you must download all files from "codefinal" and put them in the same folder, next from your you must execute the shell file by typing:
